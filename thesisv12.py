...
#uses yolo26 plate detector + yolov26 plate reader
...
model_plate = YOLO('./models/plate_detector_v26') 
...
model_char = YOLO('./models/plate_reader_v26') 
...
def update_frame():
    ...
    if should_detect:
        ...
        results = model_plate(roi_crop, verbose=False, conf=0.4)
