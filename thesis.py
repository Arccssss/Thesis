...
try:
    ...
    # AwbMode: 3 = Tungsten/Incandescent (Good for indoor lighting to fix yellow tint)
    # If 3 is still too yellow, try 4 (Fluorescent). If it's too blue, go back to 1 (Auto).
